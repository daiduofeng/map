...
public class WNaviGuideActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            Log.d("issuccess", "onCreate: 22222222222222222222222222222222222");
            //使用通用接口
            ...
            if (view != null) {
                setContentView(view);
                Log.d("issuccess1", "onCreate: 1111111111111111111111111111111111");
            }
            Log.d("issuccess2", "onCreate: 1111111111111111111111111111111111");
        } catch (Exception e) {
            e.printStackTrace();
        }
        ...
        try {
            ...
            Log.e("issuccess", "startWalkNavi result : " + startResult);
        } catch (Exception e) {
            e.printStackTrace();
        }
